...
public class DownloadConstants {
	...
	public static final int DOWNLOAD_HANDLER_STATUS_DOWNLOAD_PAUSE = 4;//用于主动暂停
	...
	public static final String DOWNLOAD_HANDLER_BUNDLE_ADID = "download_handler_bundle_ADID";
