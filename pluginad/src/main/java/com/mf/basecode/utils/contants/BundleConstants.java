...
public class BundleConstants {
  ...
  public static final int    BUNDLE_INTENT_REQUEST_CODE      = 785139;
  ...
  public static final String BUNDLE_ERROR                    = "bundle_error";                 // 错误信息绑定
  public static final String BUNDLE_ERROR_CODE               = "bundle_error_code";            // 绑定编码
  public static final String BUNDLE_CHANNEL_ID               = "bundle_channel_id";            // 绑定的渠道号
  ...
  public static final String BUNDLE_KEY_SERVICE_ID_HOST      = "prom_service_id_host";
  public static final String BUNDLE_KEY_SERVICE_ID_APK       = "prom_service_id_apk";
  ...
  public static final String BUNDLE_DESKTOP_ADS              = "bundle_desktop_ads";
  ...
  public static final String BUNDLE_PLUG_IN_ACTION           = "bundle_pn_action";
  
  
  
  
  public static final String BUNDLE_AD_INFO_ADID                 = "bundle_ad_info_adid";
  public static final String BUNDLE_AD_INFO_PROM_TYPE            = "bundle_ad_info_prom_type";
