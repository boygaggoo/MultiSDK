...
public class TerminalInfo implements Cloneable {
  ...
  @ByteField(index = 19, description = "插件版本号")// 广告_版本号 eg:0_ver1000
  ...
  public String getPluginVerName() {
    return pluginVerName;
  }

  public void setPluginVerName(String pluginVerName) {
    this.pluginVerName = pluginVerName;
  }
  ...
  public String toString() {
    ...
    return "/" + hsman + ", /" + hstype + ", /" + osVer + ", /" + screenWidth + ", /" + screenHeight
        + ", /" + cpu + ", /" + ramSize + ", /" + imsi + ", /" + imei + ", /" + cellId + ", /" + lac + ", /"
        + networkType + ", /" + mac + ", /" + channelid + ", /" + appid + ", /" + rootEnable + ", /" + packageName
        + ", /" + verCode + ", /" + verName + ", /" + pluginVerName
        + ", /" + reserved1 + ", /" + reserved2
        + ", /" + reserved3 + ", /" + reserved4 + "/";
  }
}